...
if __name__ == '__main__':
	...
	df = pd.read_excel("C:/Chandru/CWRU/Research/CCF/OphthoAvgPubsPaper/DataAnalysis.xlsx", sheet_name="InputForCode")
	df = pd.DataFrame(df, columns = ["Skip", 'Name','LastName'])
